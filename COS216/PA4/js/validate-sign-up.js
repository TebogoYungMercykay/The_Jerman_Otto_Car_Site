...
function validateSettingsForm(){
    ...
    const brand = document.getElementById("find-brand").value;
    const engineType = document.getElementById("find-engine-type").value;
    const transmission = document.getElementById("find-transmission").value;
    const bodyType = document.querySelector('input[name="body_type"]:checked');
    ...
    if (transmission !== ""){
        if (transmission !== "Automatic" && transmission !== "Manual"){
            alert("Please enter 'Automatic' or 'Manual' for the Transmission field");
            return false;
        }
    }
    if(apiKey == "" && theme == "" && transmission == "" && brand == "" && engineType == "" && bodyType == ""){
        return false;
    }
    return true;
}
